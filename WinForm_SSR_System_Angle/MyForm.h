...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->tx_TBox_RAngle->Location = System::Drawing::Point(241, 591);
				 ...
				 chartArea2->AxisX->Maximum = 2000;
				 chartArea2->AxisX->Minimum = -2000;
